...
public class MyListener implements HttpSessionListener, HttpSessionAttributeListener {
    ...
    public void attributeAdded(HttpSessionBindingEvent se)  { 
    	System.out.println("From listner Key with"
    ...
    public void attributeRemoved(HttpSessionBindingEvent se)  { 
    	...
    	System.out.println("From listner Key with"
    			+ se.getName()+ "  and value is "+ se.getValue()+"  Removed succesfully");
    ...
    public void attributeReplaced(HttpSessionBindingEvent se)  { 
    	System.out.println("From listner Key with"
    			+ se.getName()+ "  and value is "+ se.getValue()+"  Modefied succesfully");
    }
