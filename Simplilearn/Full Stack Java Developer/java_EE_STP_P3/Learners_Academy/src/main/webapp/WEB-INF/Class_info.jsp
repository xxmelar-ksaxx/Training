...
<body>
  	...
  	<div class="navDiv">
		...
		<form action="Classes_Info" method="post">
		<span class="formSpan">
			Class Number:<br/>
				 <select id="Class" name="class_info_id" required="required">
								<%
				...
				<div style="text-align: center; margin-top: -13px">
                	<button class="mnueOptions" type="submit" style="width: 6em;">Search</button>
            	</div>
		</form>
		</div>
        ...
        <table border="1" cellpadding="10">
            ...
            <tr>
                ...
                <th>No of Students</th>
                   ...
                   <%
            		List<Object[]> p=(List<Object[]>)request.getAttribute("ClassesInfoList");
            	try{
            	for(Object[] o : p){
            		%>
            		<tr>
