...
<body>
 	...
 	<form action="TCSave">
		 <span class="formSpan">
			 <br/>
			 Teacher Name:<br/>
				 <select id="Teacher" name="t_name" required="required">
							<%
							if(request.getAttribute("TeachersList") != null ) {
								List<Object[]> p=(List<Object[]>)request.getAttribute("TeachersList");
								for(Object[] o : p){
									%>
        ...
        <table border="1" cellpadding="15">
            ...
            <tr>
                ...
                <th>Time</th>
                 ...
                 <%
            		List<Object[]> p=(List<Object[]>)request.getAttribute("TCList");
            	try{
            	for(Object[] o : p){
            		%>
            		<tr>
                    ...
                    <td>
                     &nbsp;&nbsp;&nbsp;&nbsp;
                     <a href="deleteTC?id=<%=o[0]%>">Delete</a>                     
                    </td>
                </tr>
                <%
				}
